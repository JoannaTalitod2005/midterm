    const products = [
      { id: 1, name: "Microsoft Surface Laptop", price: 1500, stock: 5 },
      { id: 2, name: "WH-CH520 Wireless Headphones", price: 100, stock: 10 },
      { id: 3, name: "Fantech Fighter", price: 50, stock: 20 },
    ];
